...
class QQmlComponent(QtCore.QObject):
    ...
    def setInitialProperties(self, component: typing.Optional[QtCore.QObject], properties: dict[str, typing.Any]) -> None: ...
    ...
    def createWithInitialProperties(self, initialProperties: dict[str, typing.Any], context: typing.Optional['QQmlContext'] = ...) -> typing.Optional[QtCore.QObject]: ...
    @typing.overload
...
@typing.overload
def qmlRegisterSingletonType(a0: type, uri: typing.Optional[str], major: int, minor: int, typeName: typing.Optional[str], factory: collections.abc.Callable[[QQmlEngine, QJSEngine], typing.Any]) -> int: ...
