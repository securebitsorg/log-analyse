...
class QGeoPolygon(QGeoShape):
    ...
    def setPerimeter(self, path: collections.abc.Iterable[typing.Any]) -> None: ...
...
class QGeoPositionInfoSource(QtCore.QObject):
    ...
    @typing.overload
    @staticmethod
    def createSource(sourceName: typing.Optional[str], parameters: dict[str, typing.Any], parent: typing.Optional[QtCore.QObject]) -> typing.Optional['QGeoPositionInfoSource']: ...
    @typing.overload
    @staticmethod
    def createDefaultSource(parent: typing.Optional[QtCore.QObject]) -> typing.Optional['QGeoPositionInfoSource']: ...
    @typing.overload
    @staticmethod
    def createDefaultSource(parameters: dict[str, typing.Any], parent: typing.Optional[QtCore.QObject]) -> typing.Optional['QGeoPositionInfoSource']: ...
    def sourceName(self) -> str: ...
...
class QGeoSatelliteInfoSource(QtCore.QObject):
    ...
    @typing.overload
    @staticmethod
    def createSource(sourceName: typing.Optional[str], parameters: dict[str, typing.Any], parent: typing.Optional[QtCore.QObject]) -> typing.Optional['QGeoSatelliteInfoSource']: ...
    @typing.overload
    @staticmethod
    def createDefaultSource(parent: typing.Optional[QtCore.QObject]) -> typing.Optional['QGeoSatelliteInfoSource']: ...
    @typing.overload
    @staticmethod
    def createDefaultSource(parameters: dict[str, typing.Any], parent: typing.Optional[QtCore.QObject]) -> typing.Optional['QGeoSatelliteInfoSource']: ...
