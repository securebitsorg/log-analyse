...
class QHelpEngineCore(QtCore.QObject):
    ...
    def linksForKeyword(self, keyword: typing.Optional[str]) -> dict[str, QtCore.QUrl]: ...
    def linksForIdentifier(self, id: typing.Optional[str]) -> dict[str, QtCore.QUrl]: ...
    def fileData(self, url: QtCore.QUrl) -> QtCore.QByteArray: ...
    def findFile(self, url: QtCore.QUrl) -> QtCore.QUrl: ...
    @typing.overload
    def files(self, namespaceName: typing.Optional[str], filterAttributes: collections.abc.Iterable[typing.Optional[str]], extensionFilter: typing.Optional[str] = ...) -> list[QtCore.QUrl]: ...
    @typing.overload
    ...
    def filterAttributeSets(self, namespaceName: typing.Optional[str]) -> list[list[str]]: ...
    ...
    @typing.overload
    def filterAttributes(self, filterName: typing.Optional[str]) -> list[str]: ...
    def addCustomFilter(self, filterName: typing.Optional[str], attributes: collections.abc.Iterable[typing.Optional[str]]) -> bool: ...
