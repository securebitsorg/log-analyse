...
class QAudioDecoder(QMediaObject):
    ...
    @staticmethod
    def hasSupport(mimeType: typing.Optional[str], codecs: collections.abc.Iterable[typing.Optional[str]] = ...) -> 'QMultimedia.SupportEstimate': ...
...
class QAudioEncoderSettingsControl(QMediaControl):
    ...
    def supportedSampleRates(self, settings: 'QAudioEncoderSettings') -> typing.Tuple[list[int], typing.Optional[bool]]: ...
...
class QMediaRecorder(QtCore.QObject, QMediaBindableInterface):
    ...
    def audioSettings(self) -> 'QAudioEncoderSettings': ...
    def supportedFrameRates(self, settings: 'QVideoEncoderSettings' = ...) -> typing.Tuple[list[float], typing.Optional[bool]]: ...
    def supportedResolutions(self, settings: 'QVideoEncoderSettings' = ...) -> typing.Tuple[list[QtCore.QSize], typing.Optional[bool]]: ...
    def videoCodecDescription(self, codecName: typing.Optional[str]) -> str: ...
    def supportedVideoCodecs(self) -> list[str]: ...
    def supportedAudioSampleRates(self, settings: 'QAudioEncoderSettings' = ...) -> typing.Tuple[list[int], typing.Optional[bool]]: ...
...
class QCamera(QMediaObject):
    ...
    def supportedViewfinderResolutions(self, settings: 'QCameraViewfinderSettings' = ...) -> list[QtCore.QSize]: ...
    ...
    @staticmethod
    def availableDevices() -> list[QtCore.QByteArray]: ...
...
class QCameraExposure(QtCore.QObject):
    ...
    def supportedShutterSpeeds(self) -> typing.Tuple[list[float], typing.Optional[bool]]: ...
    def supportedApertures(self) -> typing.Tuple[list[float], typing.Optional[bool]]: ...
    def supportedIsoSensitivities(self) -> typing.Tuple[list[int], typing.Optional[bool]]: ...
...
class QCameraExposureControl(QMediaControl):
    ...
    def supportedParameterRange(self, parameter: 'QCameraExposureControl.ExposureParameter') -> typing.Tuple[list[typing.Any], typing.Optional[bool]]: ...
...
class QCameraImageCapture(QtCore.QObject, QMediaBindableInterface):
    ...
    def supportedResolutions(self, settings: 'QImageEncoderSettings' = ...) -> typing.Tuple[list[QtCore.QSize], typing.Optional[bool]]: ...
...
class QMediaContent(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(self, resources: collections.abc.Iterable['QMediaResource']) -> None: ...
    @typing.overload
...
class QMediaNetworkAccessControl(QMediaControl):
    ...
    def setConfigurations(self, configuration: collections.abc.Iterable[QtNetwork.QNetworkConfiguration]) -> None: ...
...
class QMediaPlayer(QMediaObject):
    ...
    def setNetworkConfigurations(self, configurations: collections.abc.Iterable[QtNetwork.QNetworkConfiguration]) -> None: ...
    ...
    @typing.overload
    def setVideoOutput(self, surfaces: collections.abc.Iterable[QAbstractVideoSurface]) -> None: ...
    @staticmethod
    def supportedMimeTypes(flags: typing.Union['QMediaPlayer.Flags', 'QMediaPlayer.Flag'] = ...) -> list[str]: ...
    @staticmethod
    def hasSupport(mimeType: typing.Optional[str], codecs: collections.abc.Iterable[typing.Optional[str]] = ..., flags: typing.Union['QMediaPlayer.Flags', 'QMediaPlayer.Flag'] = ...) -> 'QMultimedia.SupportEstimate': ...
...
class QMediaPlaylist(QtCore.QObject, QMediaBindableInterface):
    ...
    @typing.overload
    def insertMedia(self, index: int, items: collections.abc.Iterable[QMediaContent]) -> bool: ...
    @typing.overload
    def addMedia(self, content: QMediaContent) -> bool: ...
    @typing.overload
    def addMedia(self, items: collections.abc.Iterable[QMediaContent]) -> bool: ...
...
class QVideoSurfaceFormat(PyQt5.sipsimplewrapper):
    ...
    def propertyNames(self) -> list[QtCore.QByteArray]: ...
