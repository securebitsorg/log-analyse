...
class QBluetoothDeviceInfo(PyQt5.sip.wrapper):
    ...
    def serviceUuids(self) -> typing.Tuple[list['QBluetoothUuid'], typing.Optional['QBluetoothDeviceInfo.DataCompleteness']]: ...
    @typing.overload
    def setServiceUuids(self, uuids: collections.abc.Iterable['QBluetoothUuid'], completeness: 'QBluetoothDeviceInfo.DataCompleteness') -> None: ...
    @typing.overload
