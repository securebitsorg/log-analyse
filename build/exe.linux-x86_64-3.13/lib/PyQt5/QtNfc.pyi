...
class QNearFieldShareTarget(QtCore.QObject):
    ...
    @typing.overload
    def share(self, files: collections.abc.Iterable[QtCore.QFileInfo]) -> bool: ...
    def shareModes(self) -> QNearFieldShareManager.ShareModes: ...
...
class QNearFieldTarget(QtCore.QObject):
    ...
    def sendCommands(self, commands: collections.abc.Iterable[typing.Union[QtCore.QByteArray, bytes, bytearray]]) -> 'QNearFieldTarget.RequestId': ...
