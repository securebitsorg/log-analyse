...
class QSGMaterialShader(PyQt5.sip.wrapper):
    ...
    def setShaderSourceFiles(self, type: typing.Union[QtGui.QOpenGLShader.ShaderType, QtGui.QOpenGLShader.ShaderTypeBit], sourceFiles: collections.abc.Iterable[typing.Optional[str]]) -> None: ...
