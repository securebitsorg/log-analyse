...
class QNetworkCacheMetaData(PyQt5.sipsimplewrapper):
    ...
    def setRawHeaders(self, headers: collections.abc.Iterable[tuple[typing.Union[QtCore.QByteArray, bytes, bytearray], typing.Union[QtCore.QByteArray, bytes, bytearray]]]) -> None: ...
...
class QNetworkConfigurationManager(QtCore.QObject):
    ...
    def allConfigurations(self, flags: typing.Union['QNetworkConfiguration.StateFlags', 'QNetworkConfiguration.StateFlag'] = ...) -> list['QNetworkConfiguration']: ...
...
class QNetworkCookie(PyQt5.sipsimplewrapper):
    ...
    def __eq__(self, other: object): ...
    @staticmethod
    def parseCookies(cookieString: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> list['QNetworkCookie']: ...
...
class QSslCertificate(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def importPkcs12(device: typing.Optional[QtCore.QIODevice], key: typing.Optional['QSslKey'], certificate: typing.Optional['QSslCertificate'], caCertificates: typing.Optional[collections.abc.Iterable['QSslCertificate']] = ..., passPhrase: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...) -> bool: ...
    def __hash__(self) -> int: ...
    ...
    @staticmethod
    def fromData(data: typing.Union[QtCore.QByteArray, bytes, bytearray], format: QSsl.EncodingFormat = ...) -> list['QSslCertificate']: ...
    @staticmethod
    def fromDevice(device: typing.Optional[QtCore.QIODevice], format: QSsl.EncodingFormat = ...) -> list['QSslCertificate']: ...
    @staticmethod
    def fromPath(path: typing.Optional[str], format: QSsl.EncodingFormat = ..., syntax: QtCore.QRegExp.PatternSyntax = ...) -> list['QSslCertificate']: ...
    ...
    @typing.overload
    def subjectInfo(self, attribute: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> list[str]: ...
    @typing.overload
    def issuerInfo(self, info: 'QSslCertificate.SubjectInfo') -> list[str]: ...
    @typing.overload
    def issuerInfo(self, attribute: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> list[str]: ...
...
class QSslConfiguration(PyQt5.sipsimplewrapper):
    ...
    def setBackendConfiguration(self, backendConfiguration: dict[typing.Union[QtCore.QByteArray, bytes, bytearray], typing.Any] = ...) -> None: ...
    ...
    def setAllowedNextProtocols(self, protocols: collections.abc.Iterable[typing.Union[QtCore.QByteArray, bytes, bytearray]]) -> None: ...
...
class QSslSocket(QTcpSocket):
    ...
    @staticmethod
    def setDefaultCaCertificates(certificates: collections.abc.Iterable[QSslCertificate]) -> None: ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def addDefaultCaCertificates(certificates: collections.abc.Iterable[QSslCertificate]) -> None: ...
    def caCertificates(self) -> list[QSslCertificate]: ...
    def setCaCertificates(self, certificates: collections.abc.Iterable[QSslCertificate]) -> None: ...
    def addCaCertificate(self, certificate: QSslCertificate) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def setDefaultCiphers(ciphers: collections.abc.Iterable[QSslCipher]) -> None: ...
    @typing.overload
    def setCiphers(self, ciphers: collections.abc.Iterable[QSslCipher]) -> None: ...
    @typing.overload
