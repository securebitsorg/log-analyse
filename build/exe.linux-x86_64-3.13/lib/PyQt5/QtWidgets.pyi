...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    def insertActions(self, before: typing.Optional['QAction'], actions: collections.abc.Iterable['QAction']) -> None: ...
    def insertAction(self, before: typing.Optional['QAction'], action: typing.Optional['QAction']) -> None: ...
    def addActions(self, actions: collections.abc.Iterable['QAction']) -> None: ...
...
class QAbstractScrollArea(QFrame):
    ...
    def scrollBarWidgets(self, alignment: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag]) -> list[QWidget]: ...
...
class QAction(QtCore.QObject):
    ...
    def autoRepeat(self) -> bool: ...
    def setAutoRepeat(self, a0: bool) -> None: ...
    def shortcuts(self) -> list[QtGui.QKeySequence]: ...
    @typing.overload
    def setShortcuts(self, shortcuts: collections.abc.Iterable[typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, typing.Optional[str], int]]) -> None: ...
    @typing.overload
...
class QDirModel(QtCore.QAbstractItemModel):
    ...
    @typing.overload
    def __init__(self, nameFilters: collections.abc.Iterable[typing.Optional[str]], filters: typing.Union[QtCore.QDir.Filters, QtCore.QDir.Filter], sort: typing.Union[QtCore.QDir.SortFlags, QtCore.QDir.SortFlag], parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QFileDialog(QDialog):
    ...
    def done(self, result: int) -> None: ...
    @staticmethod
    def getSaveFileName(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: typing.Optional[str] = ..., filter: typing.Optional[str] = ..., initialFilter: typing.Optional[str] = ..., options: typing.Union['QFileDialog.Options', 'QFileDialog.Option'] = ...) -> tuple[str, str]: ...
    @staticmethod
    def getOpenFileNames(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: typing.Optional[str] = ..., filter: typing.Optional[str] = ..., initialFilter: typing.Optional[str] = ..., options: typing.Union['QFileDialog.Options', 'QFileDialog.Option'] = ...) -> tuple[list[str], str]: ...
    @staticmethod
    def getOpenFileName(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: typing.Optional[str] = ..., filter: typing.Optional[str] = ..., initialFilter: typing.Optional[str] = ..., options: typing.Union['QFileDialog.Options', 'QFileDialog.Option'] = ...) -> tuple[str, str]: ...
    @staticmethod
    def getExistingDirectoryUrl(parent: typing.Optional[QWidget] = ..., caption: typing.Optional[str] = ..., directory: QtCore.QUrl = ..., options: typing.Union['QFileDialog.Options', 'QFileDialog.Option'] = ..., supportedSchemes: collections.abc.Iterable[typing.Optional[str]] = ...) -> QtCore.QUrl: ...
    @staticmethod
...
class QGraphicsScene(QtCore.QObject):
    ...
    @typing.overload
    def items(self, pos: typing.Union[QtCore.QPointF, QtCore.QPoint], mode: QtCore.Qt.ItemSelectionMode = ..., order: QtCore.Qt.SortOrder = ..., deviceTransform: QtGui.QTransform = ...) -> list[QGraphicsItem]: ...
    @typing.overload
...
class QListWidget(QListView):
    ...
    def clear(self) -> None: ...
    def findItems(self, text: typing.Optional[str], flags: typing.Union[QtCore.Qt.MatchFlags, QtCore.Qt.MatchFlag]) -> list[QListWidgetItem]: ...
...
class QMenu(QWidget):
    ...
    @typing.overload
    @staticmethod
    def exec(actions: collections.abc.Iterable[QAction], pos: QtCore.QPoint, at: typing.Optional[QAction] = ..., parent: typing.Optional[QWidget] = ...) -> typing.Optional[QAction]: ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def exec_(actions: collections.abc.Iterable[QAction], pos: QtCore.QPoint, at: typing.Optional[QAction] = ..., parent: typing.Optional[QWidget] = ...) -> typing.Optional[QAction]: ...
...
class QTableWidget(QTableView):
    ...
    def findItems(self, text: typing.Optional[str], flags: typing.Union[QtCore.Qt.MatchFlags, QtCore.Qt.MatchFlag]) -> list[QTableWidgetItem]: ...
...
class QTreeWidget(QTreeView):
    ...
    def findItems(self, text: typing.Optional[str], flags: typing.Union[QtCore.Qt.MatchFlags, QtCore.Qt.MatchFlag], column: int = ...) -> list[QTreeWidgetItem]: ...
