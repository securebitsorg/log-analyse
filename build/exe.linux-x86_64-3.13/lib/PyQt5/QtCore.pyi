...
class QObject(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def findChildren(self, type: type[QObjectT], name: typing.Optional[str] = ..., options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> list[QObjectT]: ...
    @typing.overload
    def findChildren(self, types: tuple[type[QObjectT], ...], name: typing.Optional[str] = ..., options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> list[QObjectT]: ...
    @typing.overload
    def findChildren(self, type: type[QObjectT], regExp: 'QRegExp', options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> list[QObjectT]: ...
    @typing.overload
    def findChildren(self, types: tuple[type[QObjectT], ...], regExp: 'QRegExp', options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> list[QObjectT]: ...
    @typing.overload
    def findChildren(self, type: type[QObjectT], re: 'QRegularExpression', options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> list[QObjectT]: ...
    @typing.overload
    def findChildren(self, types: tuple[type[QObjectT], ...], re: 'QRegularExpression', options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> list[QObjectT]: ...
    @typing.overload
    def findChild(self, type: type[QObjectT], name: typing.Optional[str] = ..., options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> QObjectT: ...
    @typing.overload
    def findChild(self, types: tuple[type[QObjectT], ...], name: typing.Optional[str] = ..., options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...) -> QObjectT: ...
...
class QAbstractItemModel(QObject):
    ...
    def match(self, start: QModelIndex, role: int, value: typing.Any, hits: int = ..., flags: typing.Union[Qt.MatchFlags, Qt.MatchFlag] = ...) -> list[QModelIndex]: ...
...
class QByteArray(PyQt5.sipsimplewrapper):
    ...
    def split(self, sep: str) -> list['QByteArray']: ...
    @typing.overload
...
class QDataStream(PyQt5.sipsimplewrapper):
    ...
    def writeQVariantMap(self, qvarmap: dict[str, typing.Any]) -> None: ...
...
class QDir(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def entryInfoList(self, filters: typing.Union['QDir.Filters', 'QDir.Filter'] = ..., sort: typing.Union['QDir.SortFlags', 'QDir.SortFlag'] = ...) -> list['QFileInfo']: ...
    @typing.overload
    def entryInfoList(self, nameFilters: collections.abc.Iterable[typing.Optional[str]], filters: typing.Union['QDir.Filters', 'QDir.Filter'] = ..., sort: typing.Union['QDir.SortFlags', 'QDir.SortFlag'] = ...) -> list['QFileInfo']: ...
    @typing.overload
    def entryList(self, filters: typing.Union['QDir.Filters', 'QDir.Filter'] = ..., sort: typing.Union['QDir.SortFlags', 'QDir.SortFlag'] = ...) -> list[str]: ...
    @typing.overload
    def entryList(self, nameFilters: collections.abc.Iterable[typing.Optional[str]], filters: typing.Union['QDir.Filters', 'QDir.Filter'] = ..., sort: typing.Union['QDir.SortFlags', 'QDir.SortFlag'] = ...) -> list[str]: ...
    @staticmethod
...
class QDirIterator(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(self, path: typing.Optional[str], nameFilters: collections.abc.Iterable[typing.Optional[str]], filters: QDir.Filters = ..., flags: 'QDirIterator.IteratorFlags' = ...) -> None: ...
...
class QProcess(QIODevice):
    ...
    @typing.overload
    @staticmethod
    def startDetached(program: typing.Optional[str], arguments: collections.abc.Iterable[typing.Optional[str]]) -> bool: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    def start(self, program: typing.Optional[str], arguments: collections.abc.Iterable[typing.Optional[str]], mode: typing.Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = ...) -> None: ...
    @typing.overload
...
class QStandardPaths(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def locateAll(type: 'QStandardPaths.StandardLocation', fileName: typing.Optional[str], options: 'QStandardPaths.LocateOptions' = ...) -> list[str]: ...
    @staticmethod
...
class QTimeZone(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    @staticmethod
    def windowsIdToIanaIds(windowsId: typing.Union[QByteArray, bytes, bytearray]) -> list[QByteArray]: ...
    @typing.overload
    @staticmethod
    def windowsIdToIanaIds(windowsId: typing.Union[QByteArray, bytes, bytearray], country: QLocale.Country) -> list[QByteArray]: ...
    @typing.overload
    @staticmethod
...
class QUrl(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def toStringList(uris: collections.abc.Iterable['QUrl'], options: 'QUrl.FormattingOptions' = ...) -> list[str]: ...
...
class QUrlQuery(PyQt5.sipsimplewrapper):
    ...
    def allQueryItemValues(self, key: typing.Optional[str], options: typing.Union[QUrl.ComponentFormattingOptions, QUrl.ComponentFormattingOption] = ...) -> list[str]: ...
    ...
    def queryItems(self, options: typing.Union[QUrl.ComponentFormattingOptions, QUrl.ComponentFormattingOption] = ...) -> list[tuple[str, str]]: ...
